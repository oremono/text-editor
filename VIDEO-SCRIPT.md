...
Target: ~4 minutes. Speak the **Say** lines; do the **Do** actions while speaking. Before recording: open a normal window and an incognito window side by side, both at https://the-text-editor.vercel.app/, logged out. Have `sample.md` on the desktop.

---

## [0:00–0:25] Intro + login

**Do:** Show the live URL in the address bar, then the login page. Click alice@demo.com to fill, log in.
...
**Do:** Click New Document. Rename title to "Q3 Plan". Type a line, make it an H1; type a sentence, bold and underline words; add a bullet list. Point at the save indicator as it goes Saving → Saved. Refresh the page.
...
**Do:** Back to the list, click Upload, pick `sample.md`. Land in the new editor, scroll the converted content.
...
**Do:** Open "Q3 Plan", click Share, add bob@demo.com as Viewer. In the incognito window, log in as Bob, show "Shared with me" and the Viewer badge, open the doc, show the read-only banner and that typing does nothing. Back as Alice: change Bob to Editor. As Bob: refresh, edit a line.
...
**Do:** Briefly show ARCHITECTURE.md (permission matrix), then the tests folder or a test run.
